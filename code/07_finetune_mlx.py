...
def main():
    ...
    print()
    print("3. Fine-tune a model (example with TinyLlama 1B):")
    print("   mlx_lm.lora --model mlx-community/TinyLlama-1.1B-Chat-v1.0 \\")
    print("                --data {data_path} \\")
    print("                --adapter-path adapters/tinyllama-customer-support \\")
    print("                --iters 100 \\")
    ...
    print("   mlx_lm.generate --model mlx-community/TinyLlama-1.1B-Chat-v1.0 \\")
    print("                    --adapter-path adapters/tinyllama-customer-support \\")
